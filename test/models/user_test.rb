...
class UserTest < ActiveSupport::TestCase
  ...
  test "rejects non-image avatar" do
    ...
    assert_not u.valid?
    assert_predicate u.errors[:avatar], :any?
  end
  ...
  test "role must be editor or admin" do
    ...
    assert_not u.valid?
    assert_predicate u.errors[:role], :any?
  end
end
